...
- [ ] CHK011 Ownership / isolamento tratados para todas as novas operações de dados
- [ ] CHK012 Requisitos de auditoria tratados para operações que alteram estado (BR-011)
- [ ] CHK013 Terminologia canônica usada (Despesa, Categoria, Arquivar — sem sinônimos proibidos do glossário)
...
- Código-alvo deste projeto: `apps/web`
